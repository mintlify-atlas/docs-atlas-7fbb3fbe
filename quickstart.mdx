---
title: "Quickstart: Install ROS2 Humble with MobileRobot Scripts"
...
<Steps>
  ...
  <Step title="Run the ROS2 installer">
    ...
    <Note>
      ...
      During locale setup the script also sets the following environment variables for the current session:
